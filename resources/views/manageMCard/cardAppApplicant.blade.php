                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                <form role="form" method="POST" action={{ route('manageMCard.store') }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">No. K/P
                                                Isteri</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Tarikh Akad
                                                Nikah</label>
                                            <input class="form-control" type="text"
                                                name="mregistration[mreg_marriageDate]"
                                                value="{{ $data->mregistration->mreg_marriageDate ?? '' }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Muatnaik Gambar
                                                Passport
                                                Suami</label>
